...
%XXXXXXXX BER performance annalysis of BASK modulation Technique XXXXXXXXX
%XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX
clc;
clear all;
close all; 
num_bit=1000000;%number of bit
data=randintrlv(1,num_bit);        %random bit generation (1 or 0)
...
%XXXXXXXXXXXXXXXXXXXXXXXXXX End of program XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX%